...
public class User {
  ...
  */
  ...
  @Schema(name = "phone", example = "+36301234567", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("phone")
  ...
  public User profilePicture(Image profilePicture) {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, username, firstName, lastName, email, password, phone, profilePicture);
  }
